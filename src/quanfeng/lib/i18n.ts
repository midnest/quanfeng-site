...
export const translations = {
  zh: {
    ...
    footer: {
      contact: '联系我们',
      company: '泉州泉风电机有限公司',
      address: '地址：福建省南安市创造大道23号38幢102号',
      phone: '电话：+86-595-xxxx-xxxx',
      fax: '传真：+86-595-xxxx-xxxx',
      email: '邮箱：contact@quanfeng.hk',
      website: '网址：www.quanfeng.com',
      whatsapp: 'WhatsApp: +86-xxx-xxxx-xxxx',
  ...
  en: {
    ...
    footer: {
      ...
      address: 'Address: Room 102, Building 38, No.23 Chuangzao Avenue, Nanan City, Fujian Province, China',
      phone: 'Tel: +86-595-xxxx-xxxx',
      fax: 'Fax: +86-595-xxxx-xxxx',
      email: 'Email: contact@quanfeng.hk',
  ...
  vi: {
    ...
    footer: {
      contact: 'Liên Hệ',
      company: 'Quanzhou Quanfeng Electric Co., Ltd.',
      address: 'Địa chỉ: Phòng 102, Tòa nhà 38, Số 23 Đại lộ Chuangzao, Thành phố Nanan, Tỉnh Fujian, Trung Quốc',
  ...
  th: {
    ...
    footer: {
      contact: 'ติดต่อเรา',
      company: 'Quanzhou Quanfeng Electric Co., Ltd.',
      address: 'ที่อยู่: ห้อง 102, อาคาร 38, หมายเลข 23 ถนน Chuangzao, เมือง Nanan, มณฑล Fujian, จีน',
  ...
  ms: {
    ...
    footer: {
      ...
      company: 'Quanzhou Quanfeng Electric Co., Ltd.',
      address: 'Alamat: Bilik 102, Bangunan 38, No.23 Jalan Chuangzao, Bandar Nanan, Wilayah Fujian, China',
      phone: 'Tel: +86-595-xxxx-xxxx',
      fax: 'Fax: +86-595-xxxx-xxxx',
      email: 'Email: contact@quanfeng.hk',
      website: 'Web: www.quanfeng.com',
  ...
  tr: {
    ...
    footer: {
      contact: 'Bize Ulaşın',
      company: 'Quanzhou Quanfeng Electric Co., Ltd.',
      address: 'Adres: Oda 102, Bina 38, No.23 Chuangzao Caddesi, Nanan Şehri, Fujian Eyaleti, Çin',
      phone: 'Tel: +86-595-xxxx-xxxx',
      fax: 'Fax: +86-595-xxxx-xxxx',
      email: 'Email: contact@quanfeng.hk',
      website: 'Web: www.quanfeng.com',
  ...
  ar: {
    ...
    footer: {
      ...
      address: 'العنوان: غرفة 102، مبنى 38، رقم 23 شارع Chuangzao، مدينة Nanan، مقاطعة Fujian، الصين',
      phone: 'هاتف: +86-595-xxxx-xxxx',
      fax: 'فاكس: +86-595-xxxx-xxxx',
      email: 'البريد: contact@quanfeng.hk',
